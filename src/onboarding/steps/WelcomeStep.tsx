...
export function WelcomeStep({ t }: WelcomeStepProps) {
  ...
  const setupSteps = [
    t.onboardingWelcomeStepLanguage,
    ...
    >
      <div className="onboarding-panel">
        <div className="onboarding-panel-section">
          <div className="onboarding-panel-label">{t.onboardingWelcomeSectionFeatures}</div>
        ...
        <div className="onboarding-panel-section">
          <div className="onboarding-panel-label">{t.onboardingWelcomeSectionSetup}</div>
          <div className="onboarding-setup-roadmap">
            {setupSteps.map((label, index) => (
              <div key={label} className="onboarding-setup-step">
